...
<script>
    ...
    function plotinterval_2() {
        Plotly.extendTraces(graphDiv_Log_2, {
            y: [
                [getData(textECG_firebase[count].AVL, 0)]
            ]
        }, [0]);
    ...
    function plotinterval_3() {
        Plotly.extendTraces(graphDiv_Log_3, {
            y: [
                [getData(textECG_firebase[count].AVR, 0)]
            ]
        }, [0]);
    ...
    function plotinterval_6() {
        Plotly.extendTraces(graphDiv_Log_6, {
            y: [
                [getData(textECG_firebase[count].III, 0)]
            ]
        }, [0]);
    ...
    function plotinterval_7() {
        Plotly.extendTraces(graphDiv_Log_7, {
            y: [
                [getData(textECG_firebase[count].V1, 0)]
            ]
        }, [0]);

        cnt = cnt + 1;
        // if (cnt > 200) {
        Plotly.relayout(graphDiv_Log_7, {
            xaxis: {
                range: [0, 250]
            },
            yaxis: {
        ...
        if (count >= textECG_firebase.length) {
            count = 0;
            clearInterval(loop_7);
        }
    }
    function plotinterval_8() {
        Plotly.extendTraces(graphDiv_Log_8, {
            y: [
                [getData(textECG_firebase[count].V2, 0)]
            ]
        }, [0]);

        cnt = cnt + 1;
        // if (cnt > 200) {
        Plotly.relayout(graphDiv_Log_8, {
            xaxis: {
                range: [0, 250]
            },
            yaxis: {
        ...
        if (count >= textECG_firebase.length) {
            count = 0;
            clearInterval(loop_8);
        }
    }
    function plotinterval_9() {
        Plotly.extendTraces(graphDiv_Log_9, {
            y: [
                [getData(textECG_firebase[count].V3, 0)]
            ]
        }, [0]);

        cnt = cnt + 1;
        // if (cnt > 200) {
        Plotly.relayout(graphDiv_Log_9, {
            xaxis: {
                range: [0, 250]
            },
            yaxis: {
        ...
        if (count >= textECG_firebase.length) {
            count = 0;
            clearInterval(loop_9);
        }
    }
    function plotinterval_10() {
        Plotly.extendTraces(graphDiv_Log_10, {
            y: [
                [getData(textECG_firebase[count].V4, 0)]
            ]
        }, [0]);

        cnt = cnt + 1;
        // if (cnt > 200) {
        Plotly.relayout(graphDiv_Log_10, {
            xaxis: {
                range: [0, 250]
            },
            yaxis: {
        ...
        if (count >= textECG_firebase.length) {
            count = 0;
            clearInterval(loop_10);
        }
    }
    function plotinterval_11() {
        Plotly.extendTraces(graphDiv_Log_11, {
            y: [
                [getData(textECG_firebase[count].V5, 0)]
            ]
        }, [0]);

        cnt = cnt + 1;
        Plotly.relayout(graphDiv_Log_11, {
            xaxis: {
                range: [0, 250]
            },
            yaxis: {
        ...
        if (count >= textECG_firebase.length) {
            count = 0;
            clearInterval(loop_11);
        }
    }
    function plotinterval_12() {
        Plotly.extendTraces(graphDiv_Log_12, {
            y: [
                [getData(textECG_firebase[count].V6, 0)]
            ]
        }, [0]);

        cnt = cnt + 1;
        Plotly.relayout(graphDiv_Log_12, {
            xaxis: {
                range: [0, 250]
            },
            yaxis: {
