                ...
                <table class="table table-sm table-hover text-md-center">
                    <tbody>
                        <tr>
                            <td>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="chart_test" onclick="checkChart()"> - test <'0'></label>
                                </div>
                            </td>
                            @if($status_chart->chart_1 == 1)
                            <td>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="chart_1" onclick="checkChart()"> - AVF <'1'></label>
                                </div>
                            </td>
                            @endif
                            ...
                            <td>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="chart_2" onclick="checkChart()"> - AVF <'2'></label>
                                </div>
                            </td>
                            @endif
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="chart_3" onclick="checkChart()"> - AVR <'3'> </label>
                            ...
                            <td>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="chart_4" onclick="checkChart()"> - I <'4'> </label>
                                </div>
                            </td>
                            @endif
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="chart_5" onclick="checkChart()"> - II <'5'> </label>
                                </div>
                            </td>
                            @endif
                            ...
                            <td>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="chart_6" onclick="checkChart()"> - III <'6'> </label>
                                </div>
                            </td>
                            @endif
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="chart_7" onclick="checkChart()"> - V1 <'7'> </label>
                                </div>
                            </td>
                            @endif
                            ...
                            <td>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="chart_8" onclick="checkChart()"> - V2 <'8'> </label>
                                </div>
                            </td>
                            @endif
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="chart_9" onclick="checkChart()"> - V3 <'9'> </label>
                                </div>
                            </td>
                            @endif
                            ...
                            <td>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="chart_10" onclick="checkChart()"> - V4 <'10'> </label>
                                </div>
                            </td>
                            @endif
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="chart_11" onclick="checkChart()"> - V5 <'11'> </label>
                                </div>
                            </td>
                            @endif
                            ...
                            <td>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="chart_12" onclick="checkChart()"> - V6 <'12'> </label>
                                </div>
                            </td>
                            @endif
                        </tr>
...
<script>
    ...
    Plotly.plots(graphDiv_Log_12, data2, layout_main);
